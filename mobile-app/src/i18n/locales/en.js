export default {
  ...
  settings: {
    ...
    statusOn: 'On',
    statusOff: 'Off',
    notificationsStatusOn: 'You will receive message and call notifications',
    notificationsStatusOff: 'You will not receive app notifications',
    notificationCenter: 'Notification center',
    showOnlineStatus: 'Online status for others',
    showOnlineStatusDesc: 'Choose whether others see you as online while using the app.',
    showOnlineStatusOn: 'Show',
    showOnlineStatusOff: 'Hide',
    onlineStatusVisible: 'Others can see you as online',
    onlineStatusHidden: 'You always appear offline',
    ...
    notifWebOnly: 'Available on Android/iOS or HTTPS/localhost only',
    language: 'Language',
  ...
  stories: {
    ...
    allStory: 'All story',
    loadingFeed: 'Loading stories',
    createTitle: 'New story',
    pickSubtitle: 'Share a moment that disappears in 24 hours',
    pickPhotoVideo: 'Photo or video',
    pickPhotoVideoDesc: 'Pick from gallery or add a short clip',
    pickText: 'Text story',
    pickTextDesc: 'Colorful background and your words',
    captionPlaceholder: 'Add a caption (optional)',
    replyPlaceholder: 'Reply to story...',
    viewersTitle: 'Views',
    noViewers: 'No views yet',
    viewersSummary: '{views} views · {likes} likes',
    likedStory: 'Liked the story',
    toolText: 'Text',
    toolDraw: 'Draw',
    toolSticker: 'Sticker',
    stickerSize: 'Sticker size',
    stickerMoveHint: 'Drag to move · Pinch to scale · Corner handle to resize',
    pickSticker: 'Pick a sticker',
    textEdit: 'Edit text',
    textColor: 'Text color',
    textSize: 'Text size',
    textMoveHint: 'Drag outside the box to move · Pinch to resize',
    ...
    filterWarm: 'Warm',
    filterVivid: 'Vivid',
    videoPreviewNote: 'Video preview',
    myActiveStories: 'Your active stories',
    editStory: 'Edit',
    saveChanges: 'Save changes',
    confirmDeleteSlide: 'Delete this slide from your story?',
  ...
  shortFilms: {
    ...
    featured: 'Featured',
    allFilms: 'All films',
    empty: 'No short films yet',
    availableCount: '{n} films available',
    watchAll: 'Watch all',
    seeAll: 'See all',
    collapseStrip: 'Collapse short films',
    expandStrip: 'Show short films',
    tapFeatured: 'Tap a featured film to watch',
    allSections: 'All',
  ...
  conversationChat: {
    ...
    attachVideo: 'Video message',
    attachAlbum: 'Photo album',
    voiceMessage: 'Voice message',
    videoMessage: 'Video',
    playVideo: 'Play video',
    pauseVideo: 'Pause video',
    expandVideo: 'Enlarge video',
    muteVideo: 'Mute',
    unmuteVideo: 'Unmute',
    ...
    downloadAlbum: 'Download all photos',
    downloadCurrentPhoto: 'Current photo',
    downloadAllPhotos: 'All photos (ZIP file)',
    downloadChoose: 'Download',
    downloadSuccess: 'Download started',
    downloadAlbumZipSuccess: 'Album ZIP download started',
    downloadFailed: 'Download failed',
    albumMessage: 'Photo album',
    replyPreviewImage: 'Photo',
    replyPreviewVideo: 'Video',
    replyPreviewAlbum: 'Photo album',
    videoUploadFailed: 'Failed to upload video',
    albumUploadFailed: 'Failed to upload album',
    albumTooMany: 'You can send up to 10 photos',
    albumPhotoCount: '{n} photos',
    albumViewerCounter: '{current} / {total}',
    albumViewerPrev: 'Previous photo',
    albumViewerNext: 'Next photo',
    uploadingVideo: 'Uploading video...',
    uploadingAlbum: 'Uploading photos...',
  ...
  share: {
    inviteTitle: 'NexChat invite',
    inviteMessage: 'Join me on NexChat 🎉\nContact code: {code}\n{link}',
    linkCopied: 'Invite link copied',
    shareOpened: 'Share opened',
    storyTitle: '{name}\'s story',
    storyMessage: 'Watch {name}\'s story on NexChat 👀\n{link}',
