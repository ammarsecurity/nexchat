...
namespace NexChat.Infrastructure.Migrations
{
    ...
    [Migration("20260926142158_IndexConversationMessagesBySentAt")]
    partial class IndexConversationMessagesBySentAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NexChat.Core.Entities.ShortFilm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("StockProvider")
                        .HasMaxLength(20)
                        .HasColumnType("varchar(20)");
                    ...
                    b.HasIndex("StockProvider", "StockExternalId");

                    b.HasIndex("SectionId", "IsActive", "SortOrder");
            ...
            modelBuilder.Entity("NexChat.Core.Entities.StoryLike", b =>
                {
                    ...
                    b.HasIndex("StorySlideId", "UserId")
                        .IsUnique();

                    b.ToTable("StoryLikes");
                });

            modelBuilder.Entity("NexChat.Core.Entities.StorySlide", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("NexChat.Core.Entities.StoryView", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("StorySlideId", "ViewerUserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("NexChat.Core.Entities.ShortFilm", b =>
                {
                    b.HasOne("NexChat.Core.Entities.User", "CreatedByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("NexChat.Core.Entities.StoryLike", b =>
                {
                    b.HasOne("NexChat.Core.Entities.StorySlide", "StorySlide")
                        .WithMany("Likes")
                        .HasForeignKey("StorySlideId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NexChat.Core.Entities.StoryView", b =>
                {
                    ...
                    b.HasOne("NexChat.Core.Entities.User", "Viewer")
                        .WithMany()
